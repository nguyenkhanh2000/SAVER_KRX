...
namespace MDDSCore.Messages
{
    ...
    public /*abstract*/ class EBasePrice : EBase
    {
        /// <summary>
        /// X = Price
        /// </summary>
        ...
        public long TotalVolumeTraded { get; set; } = EGlobalConfig.__INIT_NULL_LONG;
        ...
        public long SellTotOrderQty { get; set; } = EGlobalConfig.__INIT_NULL_LONG;
        ...
        public long BuyTotOrderQty { get; set; } = EGlobalConfig.__INIT_NULL_LONG;
        ...
        public long SellValidOrderCnt { get; set; } = EGlobalConfig.__INIT_NULL_LONG;
        ...
        public long BuyValidOrderCnt { get; set; } = EGlobalConfig.__INIT_NULL_LONG;
        ...
        // ------------------------------------------------------------------------
        public double BuyPrice10 { get; set; } = EGlobalConfig.__INIT_NULL_DOUBLE;
        public long BuyQuantity10 { get; set; } = EGlobalConfig.__INIT_NULL_LONG;
        public int BuyPrice10_NOO { get; set; }
        public double BuyPrice10_MDEY { get; set; }
        public long BuyPrice10_MDEMMS { get; set; }
        // -------------------------------------
        public double SellPrice10 { get; set; } = EGlobalConfig.__INIT_NULL_DOUBLE;
        public long SellQuantity10 { get; set; } = EGlobalConfig.__INIT_NULL_LONG;
        ...
        public double OpenPriceQty { get; set; } = EGlobalConfig.__INIT_NULL_DOUBLE;
        public double ClosePrice { get; set; } = EGlobalConfig.__INIT_NULL_DOUBLE;
