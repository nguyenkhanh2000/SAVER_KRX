...
namespace MDDSCore.Messages
{
	...
	/// <para><i>no=29; name=Top N Symbols with Low Ratio of Price; type=MS; Online</i></para>
	/// <para><b>Phân phối thông tin top N cổ phiếu với tỷ lệ biến động giá thấp cho mỗi thị trường</para>
	/// <para>Thông tin thống kê này được tạo ra định kỳ trong giờ giao dịch cung cấp Top N chứng khoán giá giảm nhiều nhất. Dữ liệu sớm nhất được tạo ra sau đợt khớp lệnh định kỳ mở cửa.</para>
	/// </summary>
	[JsonObject(MemberSerialization.OptIn)]
	public class ETopNSymbolsWithLowRatioOfPrice :EBase
    {
		/// <summary>
		/// MS = Top N Symbols with Low Ratio of Price
		/// </summary>
		public const string __MSG_TYPE = __MSG_TYPE_TOP_N_SYMBOLS_WITH_LOW_RATIO_OF_PRICE;
